...
legacy_version() {
    ...
    download_link="https://raw.githubusercontent.com/noelrubio143/xuiamber/refs/heads/main/install.sh"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/noelrubio143/xuiamber/refs/heads/main/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/x-ui -N --no-check-certificate https://raw.githubusercontent.com/noelrubio143/xuiamber/refs/heads/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
